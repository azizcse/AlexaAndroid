...
import com.willblaschko.android.avs.global.Constants;
...
public class User implements Parcelable {
     ...
     * {@link } where we care about mesh logic.
    ...
    public User(Context context) {
        this();
        preferences = context.getSharedPreferences(Constants.APPLICATION_ID, MODE_PRIVATE);
    }
